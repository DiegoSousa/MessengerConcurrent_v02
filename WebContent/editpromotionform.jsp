...
<title>Edit Promotion Form</title>
</head>
<body>

<font size="5">Edit Promotion Form</font><br />
<br /> 
<font color="FF0000">* Code Promotion can not be changed.</font><br />

<form action="editpromotionform" method="post">
    Code Promotion*: <input type="text" name="promotionCode" /><br />
    <br />  
