...
public class FacadeTestWithoutConstant {
	...
	public void testAddClient() {
		...
		threadControl.prepare(getAddClientFinishedState(2));
		facade.addClient(client1);
		facade.addClient(client3);

		threadControl.waitUntilStateIsReached();

		threadControl.prepare(getListOfClientFinishedState(1));
	...
	public void testRemoveClient() {
		...
		threadControl.prepare(getRemoveClientFinishedState(1));
		threadControl.proceed();
	...
	public void testEditClient() {
		...
		threadControl.prepare(getAddClientFinishedState(1));
		facade.addClient(client1);
		threadControl.waitUntilStateIsReached();

		threadControl.prepare(getSearchClientFinishedState(1));
		threadControl.proceed();
		...
		threadControl.prepare(getEditClientFinishedState(1));
		threadControl.proceed();
	...
	public void testGetListOfClient() {
		...
		threadControl.prepare(getAddClientFinishedState(3));
		facade.addClient(client1);
	...
	public void testAddProduct() {
		...
		threadControl.prepare(getAddProductFinishedState(1));
	...
	public void testRemoveProduct() {
		...
		threadControl.prepare(getListOfProductFinishedState(2));// <----OLHAR
																// ISSO!
		threadControl.proceed();
		facade.getListProduct(copyListOfAllProduct);
	...
	public void testEditProduct() {
		...
		threadControl.prepare(getEditProductFinishedState(1));
		threadControl.proceed();
	...
	public void testSearchProduct() {
		...
		threadControl.prepare(getSearchProductFinishedState(1));
		threadControl.proceed();
		facade.searchProduct(1234, takerProductList);
	...
	public void testAddPromotion() {
		...
		threadControl.prepare(getAddPromotionFinishedState(3));
		threadControl.proceed();
	...
	public void testRemovePromotion() {
		...
		threadControl.prepare(getRemovePromotionFinishedState(2));
	...
	public void testSearchPromotion() {
		...
		threadControl.prepare(getSearchPromotionFinishedState(1));
		threadControl.proceed();
	...
	public void testAddPreferencesClient() {
		...
		threadControl.prepare(getAddProductFinishedState(2));
		facade.addProduct(book);
		facade.addProduct(table);
		threadControl.waitUntilStateIsReached();
		...
		threadControl.prepare(getAddPreferencesClientFinishedState(2));
		threadControl.proceed();
		facade.addPreferencesClient(client1, book);
		facade.addPreferencesClient(client1, table);
		threadControl.waitUntilStateIsReached();

		threadControl.prepare(getListProductPreferredClientFinishedState(1));
		threadControl.proceed();
	...
	public void testRemoveAllPreferencesClient() {
		...
		threadControl.prepare(getRemoveAllPreferencesClientFinishedState(1));
		threadControl.proceed();
	...
	public void testGetListProductPreferredClient() {
		...
		threadControl.prepare(getAddPreferencesClientFinishedState(1));
		threadControl.proceed();
		facade.addPreferencesClient(client1, book);
		threadControl.waitUntilStateIsReached();
	...
	public void getListProductPreferredAllClients() {
		...
		threadControl.prepare(getAddPreferencesClientFinishedState(3));
		threadControl.proceed();
		facade.addPreferencesClient(client1, book);
		facade.addPreferencesClient(client1, table);
		...
		threadControl
				.prepare(getListProductPreferredAllClientsFinishedState(1));
		threadControl.proceed();
		facade.getListProductPreferredAllClients(copyAllClientsPreferences);
	...
	public void testBuyProduct() {
		...
		threadControl.prepare(getBuyProductFinishedState(1));
		threadControl.proceed();
		facade.buyProduct(client, book, 2);
		threadControl.waitUntilStateIsReached();

		threadControl.prepare(getHistoricalCustomerPurchaseFinishedState(1));
		threadControl.proceed();
	...
	public void removeHistoricalOfProductsPurchasedOfCustomers() {
		...
		threadControl
				.prepare(getHistoricalPurchasesOfAllCustomerFinishedState(1));
		threadControl.proceed();
		...
		threadControl
				.prepare(getRemoveHistoricalCustomerPurchaseFinishedState(1));
		facade.removeHistoricalCustomerPurchase(client);
		threadControl.waitUntilStateIsReached();

		threadControl
				.prepare(getHistoricalPurchasesOfAllCustomerFinishedState(2));// <--OLHA
																				// ISSO
																				// AQUI!
		threadControl.proceed();
		facade.getHistoricalPurchasesOfAllCustomer(copyHistoricalOfProductsPurchasedOfAllCustomers);
	...
	public void getHistoricProductsBuyAllClient() {
		...
		threadControl.prepare(getAddClientFinishedState(4));
		facade.addClient(client);
		facade.addClient(client2);
		facade.addClient(client3);
		...
		threadControl.prepare(getAddProductFinishedState(4));
		threadControl.proceed();
		facade.addProduct(book);
		facade.addProduct(table);
		facade.addProduct(printer);
		...
		threadControl.prepare(getBuyProductFinishedState(7));
		threadControl.proceed();
		facade.buyProduct(client, book, 2);
	...
	public SystemConfiguration getAddClientFinishedState(int timesToBeInState) {
	...
	public SystemConfiguration getRemoveClientFinishedState(int timesToBeInState) {
		ThreadConfiguration config = new ThreadConfiguration(
	...
	public SystemConfiguration getEditClientFinishedState(int timesToBeInState) {
		ThreadConfiguration config = new ThreadConfiguration(
	...
	public SystemConfiguration getSearchClientFinishedState(int timesToBeInState) {
		ThreadConfiguration config = new ThreadConfiguration(
	...
	public SystemConfiguration getListOfClientFinishedState(int timesToBeInState) {
		ThreadConfiguration config = new ThreadConfiguration(
	...
	public SystemConfiguration getBuyProductFinishedState(int timesToBeInState) {
		ThreadConfiguration config = new ThreadConfiguration(
