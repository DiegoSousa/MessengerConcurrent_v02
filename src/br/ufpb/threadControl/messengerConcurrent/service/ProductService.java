package br.ufpb.threadControl.messengerConcurrent.service;
...
public class ProductService {
	...
	public Product searchProductById(String id) {
		...
		try {
			...
			facade.findProductById(jsonObject.getLong("id"), listproduct);
	...
	public Product searchProductByName(String name) {
		...
		try {
			...
			facade.searchProduct(jsonObject.getString("name"), listproduct);
			productAux = listproduct.take();
		} catch (JSONException je) {
			je.printStackTrace();
		} catch (InterruptedException ie) {
	...
	public List<Product> getListProducts() {
		...
		facade.getListProduct(listproduct);
